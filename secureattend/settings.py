"""
Django settings for SecureAttend project.
"""
...
ROOT_URLCONF = 'secureattend.urls'
...
WSGI_APPLICATION = 'secureattend.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'secureattend_db',
        'USER': 'root',
        'PASSWORD': 'password',
        'HOST': 'localhost',
        'PORT': '3306',
...
FACE_ENCODINGS_PATH = BASE_DIR / 'face_encodings'
FACE_ENCODINGS_PATH.mkdir(exist_ok=True)
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'secureattend.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
